 ...
 */
var loadFile = function(filePath, mocks, globals, mockNested, requireCache) {
  mocks = mocks || {};
  globals = globals || {};
  ...
  var context = {
    require: function(name) {
      ...
      name = path.resolve(path.dirname(filePath), name);
      ...
      if (mockNested) {
        ...
        return requireCache[name] = loadFile(name, mocks, globals, mockNested, requireCache).module.exports;
      }
